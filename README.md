...
> [!CAUTION]
> `"Faster_Avatar_Sprint_Speed"` no longer works with the most recent version of VRChat.
...
## [Download Here](https://github.com/SFD-Shadow/Advanced_Avatar_Movement/releases/tag/v1.0.0)
